(* OASIS_START *)
(* DO NOT EDIT (digest: e9c67b1dd77a180e83e9452cc5be21b1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_core";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("compiler-libs.bytecomp", None);
                   ...
                   {exec_custom = false; exec_main_is = "gen.ml"});
               Executable
                 ({
                     cs_name = "gen_ast_pattern";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "gen_ast_pattern.ml"});
               Executable
                 ({
                     cs_name = "gen_ast_builder";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "gen_ast_builder.ml"})
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some ";S\028\184\1766\130\129\129\143\172(\240jnu";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
